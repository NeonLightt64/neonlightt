...
class Drawing {
    constructor(msg, size, fg, bg) {
        ...
        msg.edit("Kalemi hareket ettirmek için tepkileri kullanın: \n✅ Çizimi Durdur | Kalem Açık | Kalem Kapalı");
        this.reactArrows(0);
    ...
    stop(reason = "") {
        ...
        this.msg.edit("NeonLight ile çizdiğiniz için teşekkürler!" + reason);
    ...
    handleReaction(reaction) {
        ...
        reaction.remove(reaction.users.last()).catch(e => {
            if (e.code === 50013) reaction.message.channel.send("Düzgün çalışmam için `Mesajları Yönet` yetkisine ihtiyacım var!");
        });
        this.drawCanvas();
    }
