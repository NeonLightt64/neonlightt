...
exports.run = function(client, message, args) {
  ...
  var ka = client.emojis.get(client.emojiler.kapalıA);
    if (type.length < 1) return message.channel.send("Lütfen önerinizi yazın. Örnek kullanım: ``/öneri Güncellemeler getirilsin``");
...
client.channels.get('769542505834217522').send(embed2).then(m => m.react(ac,
m.react(ka)))
