...
${y}**Otomatik tag ${dil.ayarlar.errors.system}** ${db.has(`tagB_${message.guild.id}`) ? ac + db.fetch(`tagB_${message.guild.id}`) : `${ka} ${dil.ayarlar.errors.notset} **${prefix}tag-ayarla**`}
${y}**Otomatik tag ${dil.ayarlar.errors.channel}** ${db.has(`tagKanal_${message.guild.id}`) ? ac + message.guild.channels.get(db.fetch(`tagKanal_${message.guild.id}`)).name : `${ka} ${dil.ayarlar.errors.notset} **${prefix}tag-kanal-ayarla**`}
