...
const footer = `[${dil.special.botinvite}](https://discordapp.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=8) | [${dil.special.supportserver}](https://discordapp.com/invite/GacVPGE) | [Web Paneli](${client.ayarlar.webpanel})\n \`NeonLight'ın Geliştiricisi (ИL) И Ξ Ф И L I G H Γ շօյՑ#3192\``;

  var arg = ``
 if(args[0] === '') {
      let müzik = [`
      Müzik Komutları bir süre bakımdadır!
