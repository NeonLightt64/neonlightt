...
exports.run = async (bot, message, args) => {
 ...
 message.client.channels.get('727372765782343701').send(`<a:kirmizi:690267037745807431> \`${nesne}\` ID'li Kullanıcı Gold Üyeliğe Eklendi <a:kirmizi:690267037745807431>`)
